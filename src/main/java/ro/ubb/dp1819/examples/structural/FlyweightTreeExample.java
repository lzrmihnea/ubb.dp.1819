...
/**
 * This is the flyweight intrinsic - coordinates extrinsic - name, texture and
 * color of tree (using TreeType class)
 */
class Tree {
    private int x;
    private int y;
...
/**
 * Used to store the extrinsic attributes for trees
 */
class TreeType {
    private String name;
    private Color color;
...
/**
 * We use a (singleton) factory to get tree instances. This ensures that we do
 * not duplicate instances needlessly
 */
class TreeFactory {
...
public class FlyweightTreeExample {
