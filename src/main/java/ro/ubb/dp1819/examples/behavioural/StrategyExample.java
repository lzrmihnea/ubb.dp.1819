package ro.ubb.dp1819.examples.behavioural;
...
class CreditCardPayment extends PaymentStrategy {
    @Override
    public void registerPayment(int totalSum) throws Exception {
        // mock-up
...
public class StrategyExample {
    public static void main(String[] args) {
        ...
        List<Equipment> purchases = new ArrayList<>();
        ...
        int total = 0;
        Iterator<Equipment> it = purchases.iterator();
        while (it.hasNext()) {
